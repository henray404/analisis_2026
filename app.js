(function (root) {
  ...
  function formatRunningTestEntry(rt) {
    ...
    return [
      ...
      'waktu ambil staf: ' + formatMenitDetikMs(run.r1.waktuStaf),
      'waktu assembly: ' + formatMenitDetikMs(run.r1.waktuAssembly),
      '',
      'storage spear: ' + run.r1.storageSpear + ' spear',
      'storage kfs: ' + run.r1.storageKfs + ' kotak',
      'waktu masuk arena: ' + formatMenitDetikMs(run.r1.waktuMasukArena),
      'kesusahan ambil kfs di index: ' + run.r1.kesusahanIndex,
      'waktu ambil kfs: ' + formatMenitDetikMs(run.r1.waktuAmbilKfs),
      '',
      'waktu perjalanan forest-arena: ' + formatMenitDetikMs(run.r1.waktuForestArena),
      ...
      'waktu ambil spearhead: ' + formatMenitDetikMs(run.r2.waktuSpearhead),
      '',
      ...
      'waktu taruh kfs di rak: ' + formatMenitDetikMs(run.r2.waktuTaruhRak)
    ].join('\n');
  }
